...
class DeepLTranslationServiceTest extends UnitTestCase
{
    ...
    public function translateUsesCacheIfPresent(): void
    {
        ...
        $mockTranslationCache
            ...
            ->method('get')
            ->willReturnCallback(
                function (string $sourceText, string $targetLanguage, ?string $sourceLanguage = null) {
        ...
        $mockTranslationCache
            ...
            ->method('set')
            ->willReturnCallback(
                fn(string $sourceText, string $targetText, string $targetLanguage, ?string $sourceLanguage = null) => match ($expectedSetCount->getInvocationCount()) {
