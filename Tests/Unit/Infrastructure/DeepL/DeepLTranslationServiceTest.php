...
class DeepLTranslationServiceTest extends UnitTestCase
{
    ...
    protected DeepLAuthenticationKey $mockDeeplAuthenticationKey;
    ...
    public function setUp(): void
    {
        ...
        $this->mockDeeplAuthenticationKey = $this->createMock(DeepLAuthenticationKey::class);
        $this->mockDeeplAuthenticationKeyFactory->expects(self::any())->method('createDeepLAuthenticationKey')->willReturn($this->mockDeeplAuthenticationKey);
    ...
    public static function translateWillCorrectlyTranslateTextsData(): \Generator
    {
        yield "single_text" =>  [
                ['foo'],
                'de',
        ...
        yield "multiple_texts" =>  [
                ...
                [
                    new TextResult('de_foo', 'de', 3),
                    new TextResult('de_bar', 'de', 3),
                    new TextResult('de_baz', 'de', 3)
                ]
            ];
